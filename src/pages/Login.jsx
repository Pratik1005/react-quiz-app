...
const Login = () => {
    ...
    const handleLogin = (e) => {
        e.preventDefault();
        if (loginData.email === "test@gmail.com" && loginData.password === "test@123") {
            navigate("/user");
        }else {
    ...
    return (
        ...
        <form>
            ...
            <div className="form-control">
                ...
                <input type="email" name="email" id="email" placeholder="name@gmail.com" value={loginData.email} onChange={e => handleEmail(e)}/>
            </div>
            <div className="form-control">
                <label htmlFor="password" className="fw-bold">Password</label>
                <input type="password" name="password" id="password" value={loginData.password} placeholder="&lowast;&lowast;&lowast;&lowast;&lowast;&lowast;&lowast;&lowast;" onChange={e => handlePassword(e)}/>
            </div>
            <div className="form-control">
            ...
            <div className="form-control">
                <button className="btn btn-primary-outline" onClick={e => handleTestLogin(e)}>Login with test credentials</button>
            </div>
